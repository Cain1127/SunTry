...
//            [sectionBtn setImage:[UIImage imageNamed:@"menu_catalogBtn_p.png"] forState:UIControlStateNormal];
            [sectionBtn setTitleColor:[UIColor colorWithRed:168/255.0 green:43/255.0 blue:37/255.0 alpha:1] forState:UIControlStateNormal];
...
-(void)showChooseListViewInSection:(NSInteger)section choosedIndex:(NSInteger)index
{
    ...
    CGRect rect = self.mTableView.frame;
    rect.origin.x = sectionWidth *section+10.5;
